...
OrthogonalLinkReshapingTool.prototype.makeAdornment = function (pathshape) {
  ...
  var adornment = go.LinkReshapingTool.prototype.makeAdornment.call(
    this,
    pathshape
  );
 ...
 * @this {OrthogonalLinkReshapingTool}
 */
OrthogonalLinkReshapingTool.prototype.makeSegmentDragHandle = function (
  link,
  adornment,
  index
) {
  ...
  var orient = "";
  if (
    OrthogonalLinkReshapingTool.isApprox(a.x, b.x) &&
    OrthogonalLinkReshapingTool.isApprox(a.y, b.y)
  ) {
